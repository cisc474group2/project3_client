...
export class EventModel{
	...
	public constructor(title:string, description:string, event_address:string, start_time:string, end_time:string, _id:string='', bus_id:string='', registered_ind:string[]=[], geoloc:Geoloc = new Geoloc(0, 0), create_date:Date=null, registered:boolean=false, actual_bus_id: string){
		this._id = _id;
		this.title = title;
		this.bus_id = bus_id;
